...
;------------------------------------------------------------------------------------
            ...
            ;------------------------------------------------------------------------------------
            to rred-go
                   ifelse not any? patches with [pcolor = yellow] in-radius 2 
                   [
              fd 1
...
;------------------------------------------------------------------------------------
            ...
            ;------------------------------------------------------------------------------------
            to rredsave
              ifelse (patch-here = one-of patches with [rredsavestation ])
              [
                ask patch-here
                [
                  set rredsavestation false
              ...
              [ 
 ;               if any? patches with [rredsavestation = true]
  ;              [
